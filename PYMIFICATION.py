                    ...
                    for i, choice in enumerate(question["options"]):
                        ...
                        if rect.collidepoint(mouse_x, mouse_y):
                            ...
                            if choice == question["answer"]:
                                textright = big_font.render("Correct!", True, BLACK)
                                animate_confetti(3000, GREEN, textright)
                                ...
                                textwrong = big_font.render("Incorrect", True, BLACK)
                                correctanswer = font.render(f"The correct answer was: {question['answer']} ", True, BLACK)
                                screen.fill(RED)
                                screen.blit(textwrong, (460,300))
                                screen.blit(correctanswer, (250,370))
                                pygame.display.flip()
